...
export function SidePanel({ activeItem, onSelectMenu, user, profile, onLogout }: SidePanelProps) {
  ...
  return (
    <aside className={`relative flex h-screen flex-col justify-between bg-[#E5E5E5] p-6 shadow-[inset_-1px_0_0_0_rgba(0,0,0,0.05)] select-none transition-all duration-300 ease-in-out ${isCollapsed ? "w-20 px-3" : "w-72"}`}>
